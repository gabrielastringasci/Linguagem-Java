...
public class Produto {
	...
	public String toString() {
		return " Código: " + getCodigo() + " Descricao: " + getDescricao() + " UnidadeMedida: " + getUn().getDescricao() + " Largura: " + getLargura() + 
				" Comprimento: " + getComprimento() + " Situação: " + getSituacao() + "Localização: " + getLocalizacao();
	}
