...
public class ControleFrota extends JFrame implements ActionListener {
	...
	private boolean cadastrar() {
		...
		//Operador ternario para verificar se houve sucesso no cadastro
		JOptionPane.showMessageDialog(null, veiculos[contadorVeiculos - 1] != null ? "Veículo cadastrado!" : "Erro");
	...
	private void alterar() {
		...
		//Operador ternario para verificar se houve sucesso na alteração
		 txtModelo.setText(novoVeiculo != null ? novoVeiculo.getModelo() : "");
		 comboBoxFabricante.getComboBox().setSelectedItem(novoVeiculo != null ? novoVeiculo.getFabricante() : "");
		 txtAno.setText(novoVeiculo != null ? String.valueOf(novoVeiculo.getAnoFabricacao()) : "");
		 txtValor.setText(novoVeiculo != null ? String.valueOf(novoVeiculo.getValor()) : "");
		 txtDataCompra.setText(novoVeiculo != null ? String.valueOf(novoVeiculo.getDataCompra()) : "");
	...
	private void pesquisar() {
		...
		//Operador ternario para verificar se houve sucesso na pesquisa
		JOptionPane.showMessageDialog(null, veiculoEncontrado != null ? "Veículo encontrado!" : "Erro");
		
		txtModelo.setText(veiculoEncontrado != null ? veiculoEncontrado.getModelo() : "");
		comboBoxFabricante.getComboBox().setSelectedItem(veiculoEncontrado != null ? veiculoEncontrado.getFabricante() : "");
		txtAno.setText(veiculoEncontrado != null ? String.valueOf(veiculoEncontrado.getAnoFabricacao()) : "");
		txtValor.setText(veiculoEncontrado != null ? String.valueOf(veiculoEncontrado.getValor()) : "");
		txtDataCompra.setText(veiculoEncontrado != null ? String.valueOf(veiculoEncontrado.getDataCompra()) : "");
	}
